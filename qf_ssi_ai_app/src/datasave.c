...
static const char s_riversensor[] = "RiverSensorX,RiverSensorY,RiverSensorZ,RiverSensorADC3";
...
static const char s_ssss_titles[] = "RiverSensorX,RiverSensorY,RiverSensorZ,RiverSensorADC3";
...
static void json_add_ssss( struct riff_object *pObj )
{
    ...
    char column_titles[] = "RiverSensorX,RiverSensorY,RiverSensorZ,RiverSensorADC3";
